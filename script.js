    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "OFEK TOVAL משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '05d94dcd-7477-4940-ba9e-27786deca9b8',
                    name: data.name || '',
                    email: data.email || '',
